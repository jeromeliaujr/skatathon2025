...
const images = ref([
  { src: '../img/sponsor1.webp', alt: 'Sponsor 1 Logo' },
  { src: '../img/sponsor2.webp', alt: 'Sponsor 2 Logo' },
  { src: '../img/sponsor3.png', alt: 'Sponsor 3 Logo' },
  { src: '../img/sponsor4.webp', alt: 'Sponsor 4 Logo' },
  { src: '../img/sponsor5.webp', alt: 'Sponsor 5 Logo' },
  { src: '../img/sponsor6.png', alt: 'Sponsor 6 Logo' },
  { src: '../img/sponsor7.webp', alt: 'Sponsor 7 Logo' },
  { src: '../img/sponsor8.webp', alt: 'Sponsor 8 Logo' },
])
