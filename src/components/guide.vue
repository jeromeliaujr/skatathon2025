...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/67u8ho4wh8dx9omj3iedq/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=bospfa7q3zdgsklq3i0wj45mz&st=hzab1d80&dl=0', '_blank');
    }
  }
}
</script>
