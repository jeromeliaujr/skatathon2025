...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/08svgr989ya3ba624g5z2/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=5xfirchom2mm6ltncxqx1rtpk&st=9p1ze6y7&dl=0', '_blank');
    }
  }
}
</script>
