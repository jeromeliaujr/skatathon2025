...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/i5330ib5mjsosbso3plsx/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=xhz4mexr4qpihle2ulcdecbt8&st=33g86og5&dl=0', '_blank');
    }
  }
}
</script>
