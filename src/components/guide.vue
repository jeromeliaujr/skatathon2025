...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/jjhjunk1kw0bj9x6o04kd/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=2qc0cpfiqkxsoru1jb4myamga&st=ktnws0sp&dl=0', '_blank');
    }
  }
}
</script>
