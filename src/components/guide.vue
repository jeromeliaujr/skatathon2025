...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/qf8p42p4z65tfp2cefus2/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=j8neq19x91vk78neyrk0rg81j&st=halwcbp8&dl=0', '_blank');
    }
  }
}
</script>
