...
export default {
  data() {
   ...
   methods: {
    openLink() {
      window.open('https://www.dropbox.com/scl/fi/l1wlqruoq13n06mh6r36f/SMU-Skatathon-2025-Race-E-Guide.pdf?rlkey=jou4ut4xkxzm24ful8e572huv&st=a5kx8pu5&dl=0', '_blank');
    }
  }
}
</script>
